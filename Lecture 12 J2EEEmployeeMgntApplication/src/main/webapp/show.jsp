...
<body>
	...
	<div class="row">
		...
		<div class="container">
			...
			<form action="EmployeeController" method="get">
			<input type="hidden" name="action" value="searchbydob">
			...
			<form action="EmployeeController" method="get">
			<input type="hidden" name="action" value="searchbydept">
			...
			<form action="EmployeeController" method="get">
			<input type="hidden" name="action" value="checkloaneligibility">
			<input type="text" name="empid">
			<input type="submit" value="Check Loan Eligibility"> 
